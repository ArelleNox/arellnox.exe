...
UI_TEXT = { "en": { "eyebrow": "a personal, no-niche blog", "hero_title": "Thoughts kept<br>at <em>quiet</em> hours", "hero_desc": "<strong>No niche, no schedule</strong> — just the things I'm learning, playing, cooking and coding.", "btn_read": "Read the journal →", "shelves_h2": "What lives here", "posts_h2": "Recent entries", "footer": "Arellnox — a slow blog, updated when there's something worth saying", }, 
            ...
            "ja": { "eyebrow": "テーマのない個人ブログ", "hero_title": "静かな時間に<br>綴った<em>想い</em>", "hero_desc": "<strong>テーマもスケジュールもなく</strong>—学んでいること、遊んでいること、料理やコーディングのことなど。", "btn_read": "ジャーナルを読む →", "shelves_h2": "ここにあるもの", "posts_h2": "最近の記事", "footer": "Arellnox — 書くことがあるときに更新する、ゆっくりしたブログ", }, }
